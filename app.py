...
from rag_utils import fuzzy_match, get_eval_metrics  # new function we'll define below
...
Q: {query}
A:"""
        answer = query_groq(fewshot).strip()
        ...
        # 🔍 Insight Mode - meaningful follow-up
...
"""
        ...
        # 📏 Inline Evaluation (if question matches in evaluation_dataset.jsonl)
...
# === Evaluation Dashboard (full batch test)
if show_eval:
